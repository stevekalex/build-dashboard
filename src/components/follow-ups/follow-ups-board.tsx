...
function totalCount(columns: FollowUpColumns): number {
  return columns.followUp1.length + columns.followUp2.length + columns.closeOut.length
}
...
export function FollowUpsBoard({ overdue, upcoming }: FollowUpsBoardProps) {
  ...
  const allIds = [
    ...overdue.followUp1, ...overdue.followUp2, ...overdue.closeOut,
    ...upcoming.followUp1, ...upcoming.followUp2, ...upcoming.closeOut,
