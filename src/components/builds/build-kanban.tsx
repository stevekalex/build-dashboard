  ...
  return (
    <div className="w-full">
      ...
      <div className="hidden md:grid md:grid-cols-3 gap-4">
        <BuildColumn title="Building" emoji="🔨" builds={building} accentColor="amber" tooltip='Stage = "✅ Approved"' />
        <BuildColumn title="Deployed" emoji="🚀" builds={deployed} accentColor="emerald" tooltip='Stage = "🏗️ Deployed"' />
        <BuildColumn title="Failed" emoji="💥" builds={failed} accentColor="red" tooltip='Stage = "⚠️ Build Failed"' />
      </div>
